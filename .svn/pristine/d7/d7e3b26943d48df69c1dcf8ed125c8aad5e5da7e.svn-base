...
<head>
    ...
    <@js src="js/siping/report/outWarehouse.js" />
</head>
<body>
<div class="list_page">
    <div class="head_top_">
        <div class="rect_block" onclick="preViewOutWarehouse();"> 
    ...
    <div class="search_section">
        ...
        <div class="report_search_text common_text_div">
            ...
            <div class="common_text_val"><select id="storageId" class="my_radius"></select></div>
        </div>
        <div class="report_button_text common_text_div">
            <button onclick="outWarehouseGrid(1,10)" class="btn_common my_radius btn_search">查询</button>
        </div>
        <div style="clear:both"></div>
        <div style="clear:both"></div>
    </div>
    <div id="out_warehouse_grid"></div>
    <div style="display:none;" id="out_warehouse_grid_print"></div>
</div>
</body>
</html>

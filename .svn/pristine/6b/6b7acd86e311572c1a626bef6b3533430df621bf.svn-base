...
<head>
    ...
    <@js src="js/siping/report/inWarehouse.js" />
</head>
<body>
<div class="list_page">
    <div class="head_top_">
        <div class="rect_block" onclick="preViewInWarehouse();"> 
    ...
    <div class="search_section">
        ...
        <div class="report_button_text common_text_div">
            <button onclick="inWarehouseGrid(1,10)" class="btn_common my_radius btn_search">查询</button>
        </div>
        <div style="clear:both"></div>
        <div style="clear:both"></div>
    </div>
    <div id="in_warehouse_grid"></div>
    <div style="display:none;" id="in_warehouse_grid_print"></div>
</div>
</body>
</html>

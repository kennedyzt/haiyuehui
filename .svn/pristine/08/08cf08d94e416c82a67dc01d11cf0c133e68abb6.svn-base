<@insert template="layout/print">
    <div class="print_head"><span>重庆瑞乾科技销售退货单</span></div>
    ...
    <div class="order_btns_l common_text_div">
        <button id="" class="btn_common my_radius">打印</button>
        <button id="" class="btn_common my_radius">取消</button>
    </div>
</@insert>
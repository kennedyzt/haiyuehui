...
<@insert template="login/right">
    <div class="add_page">
        ...
        <div id="partner_section_1">
            ...
            <div class="partner_text_div common_text_div">
                ...
                <div class="common_text_val"><input id="addressEn" value = "${businessPartner.addressEn}" class="input_text_common my_radius"></div>
            </div>
            <div class="partner_text_div common_text_div">
                ...
                <div class="common_text_val">
                    <select id="countryRegionId" class="my_radius">
                        ...
                        <#list countryRegions as country>
                            <option <#if businessPartner.countryRegionId==country.id>selected</#if> value="${country.id}">${country.countryRegionName}</option>
                        </#list>
                    </select>
                </div>
            </div>
            <div class="partner_text_div common_text_div">
                ...
                <div class="common_text_val">
                    <select id="businessType" class="my_radius">
                        <option></option>
                        <option <#if businessPartner.businessType==1>selected</#if> value="1">出口商</option>
                        <option <#if businessPartner.businessType==2>selected</#if> value="2">代理商</option>
                        <option <#if businessPartner.businessType==3>selected</#if> value="3">出口商/代理商</option>
                    </select>
                </div>
            </div>
            <div class="partner_text_div common_text_div">
                <div class="common_text_title">邮政编码</div>
                <div class="common_text_val"><input id="postalCode" value = "${businessPartner.postalCode}" class="input_text_common my_radius"></div>
            </div>
            <div class="partner_text_div common_text_div">
        ...
        <div id="partner_section_2">
            ...
            <div class="partner_text_div common_text_div">
                <div class="common_text_title">传真</div>
                <div class="common_text_val"><input id="contactsFax" value = "${businessPartner.contactsFax}" class="input_text_common my_radius"></div>
            </div>
            <div class="partner_text_div common_text_div">
                <div class="common_text_title">邮箱</div>
                <div class="common_text_val"><input id="contactsEmail" value = "${businessPartner.contactsEmail}" class="input_text_common my_radius" data-click-tip="请不要填写hotmail和gmail邮箱" placeholder="请不要填写hotmail和gmail邮箱"></div>
            </div>
            <div class="partner_text_div common_text_div">
                <div class="common_text_title">备注</div>
    ...
    <div class="user_btns_l common_text_div">
        ...
        <button id="supplier_smt_edit" class="btn_common my_radius btn_submit">保存</button>

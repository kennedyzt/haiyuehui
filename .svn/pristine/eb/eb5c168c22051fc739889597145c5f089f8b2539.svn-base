...
<@insert template="login/right">
    <div class="search_section">
    	<form action="<@url value='/purchaseorderreturn/getdraftlist'/>" method="post">
    ...
    <table>
        <thead>
            <tr>
                <td width="10%"><a class="td_head_a" onclick="deleteDraftReturnPO()" data-hover-tip="删除"><img src="<@static value='/icons/delete.png' />"></a></td>
                <td width="10%">单据编号</td>
                <td width="10%">单据日期</td>
                <td width="10%">出库仓库</td>
                <td width="10%">供应商</td>
            	...
            	<#list pageModel.records as p>
	                <tr>
	                    <td width="10%">
	                        ...
	                        <a class="td_inner_a" href="<@url value='/purchaseorderreturn/edit?returnsNumber=${p.returnsNumber}' />" data-hover-tip="修改"><img src="<@static value='/icons/edit.png' />"></a>
	                    </td>
    ...
    <#if pageModel.totalRecords??>
        <@pageByParam url="/purchaseorderreturn/getdraftlist" pageNo="${pageModel.pageNo}"  pageSize="${pageModel.pageSize}" totalRecords="${pageModel.totalRecords}"/>
    </#if>

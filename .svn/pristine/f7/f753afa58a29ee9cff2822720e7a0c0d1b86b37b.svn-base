...
<@insert template="login/right">
    ...
    <div class="order_add_prowin">
        ...
        <button class="my_radius" onclick="openWinGetMaterial('chooseStorageReceiptMaterial',false,false,true);" type="button">添加</button>
    </div>
    ...
    <div class="grid_bottom">
        ...
        <div class="grid_page_text_div common_text_div">
            ...
            <div class="common_text_val"><span class="readonly_text_common grid_page_text" id="totalGiftPrice"></span></div>
        </div>
        <#--<div class="grid_page_text_div common_text_div">

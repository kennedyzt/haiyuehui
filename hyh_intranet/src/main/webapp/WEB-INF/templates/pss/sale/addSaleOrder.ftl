...
<@insert template="login/right">
    <div class="head_section">
        ...
        <div class="grid_page_text_div common_text_div">
            ...
            <div class="common_text_val"><input id="shipmentsDate" data-type="date" class="input_text_common my_radius grid_page_text"></div>
        </div>
        <div class="grid_page_text_div common_text_div">
            <div class="common_text_title">出库仓库</div>
                ...
                <tbody id="dataSource">
                    <#list 0..9 as i>
                        <tr id= "${i_index+1}">
                            ...
                            <td><img onclick="addSaleOrderRow(this);" src="<@static value='/icons/tree_hide.png' />"><img onclick="removeGridRow(this)" src=<@static value="/icons/tree_show.png"/>"></td>
                            <td><div class="common_text_val common_text_val_table"><input data-type="saleMaterial" name="materialNo" class="input_choose_text input_choose_short_text my_radius grid_text"><input type = "hidden" name = "materialId"><div class="more" onclick="openWinGetMaterials('chooseSaleOrderMaterial',false,true,false,this);"></div></div></td>

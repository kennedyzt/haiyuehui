...
function inWarehouseGrid(pageNo, pageSize){
    siping.fillGrid({
        content : "in_warehouse_grid",
        width : "100%",
        height : "500px",
        ajax : {
            type : "post",
            url : "report/inwarehouse/getdata",
            async : true, 
        ...
        page : {options : [10,20,30,50,80], fn : "inWarehouseGrid"},
        rowNum : true
    });
}


function preViewInWarehouse() {
    var request = {};
    ...
    siping.ajax({
        ...
        success : function(data) {
            ...
            var strFormHtml = strStyleCSS + "<body>" + document.getElementById("in_warehouse_grid_print").innerHTML + "</body>";
            LODOP.PRINT_INIT("打印收货统计");
...
function createDataSourceHtml(data) {
    var dataSourceHtml = '<table class = "print_table"><caption><b><font face="黑体" size="4">收货统计</font></b></caption><thead><tr><th>商品货号</th><th>国际编码</th><th>商品名称</th><th>商品类型</th><th>仓库编码</th><th>仓库名称</th><th>单位</th><th>数量</th></tr></thead><tbody>';
    ...
    $("#in_warehouse_grid_print").append(dataSourceHtml);
}
package com.siping.smartone.purchase;

import java.io.Serializable;

public class PurchaseItemBase implements Serializable {

    private static final long serialVersionUID = -3406423170989736841L;
